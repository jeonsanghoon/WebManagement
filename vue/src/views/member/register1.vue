                  ...
                  <v-layout wrap>
                    ...
                    <v-flex xs12 md6>
                      <Vuetify-datePicker
                        ...
                        @dateChange="componentCallbackDateChange"
                      />
                    </v-flex>
                    <v-flex xs12 md6>
                      <Vuetify-selectsCommon
                        ...
                        class="mt-4"
                        @selectChange="componentCallbackSelectChange"
                      ></Vuetify-selectsCommon>
                    </v-flex>
                  </v-layout>
                </v-container>
...
export default {
  ...
  methods: {
    ...
    /** 컴포넌트 콜백 메서드 */
    componentCallbackSelectChange: function(selectedData, name) {
      console.log(name)
      this.formData.authType = selectedData
    },
    componentCallbackDateChange: function(res, name) {
      console.log(name)
